...
This repository contains the worked sample app for the [SpringBoot @ConfigurationProperties in Grails App](https://grails.apache.org/guides/grails-configuration-properties/4/guide/index.html) guide on the Apache Grails site.
